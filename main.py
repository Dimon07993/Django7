            ...
            <div class="row text-center">
                ...
                <div class="col-4">
                    <div class="card-body">
                        ...
                        <form>
                            <div class="mb-3">
                                <input name="name" "type="text" class="form-control" id="exampleFormControlInput1" placeholder="name" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <input name="email" type="email" class="form-control" placeholder="email" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <input name="massage" type="text" class="form-control" placeholder="massage" id="exampleFormControlTextarea1" >
                            </div>
                            <button type="submit" class="w-100 btn btn-lg btn-success">Отправить</button>
                        </form>
                    </div>
                </div>
...
<script>
    ...
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(bytes(self._get_html_content(), "utf-8"))
